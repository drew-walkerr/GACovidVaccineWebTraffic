...
get_ga_dph_vaccine_orders_list <- function() {
  ...
  library(pdftools)
  library(assertthat)
url <- "https://dph.georgia.gov/document/document/vaccine-orders-list/download"
download.file(url,"data/vaccine_orders_list_raw.pdf", mode="wb")
...
vaccine_order_list <- get_ga_dph_vaccine_orders_list()
```
